		...
		<view class="content" @tap="toDetails(item.id)">
			...
			<view class="bottom-btn padding-bottom-sm">
				<view class="btn-item flex-center">
					<image class="img" src="../../static/images/forum/img_say.png" mode="widthFix"></image>
					<text>{{ item.commentNum }}</text>
				</view>
				<view class="btn-item flex-center" @tap.stop @tap="handleLike(item.id, item.isLike, item.likeNum)">
					<image class="img" v-if="!item.isLike" src="../../static/images/forum/img_zan.png" mode="widthFix"></image>
					<image class="img" v-else src="../../static/images/forum/img_zan_1.png" mode="widthFix"></image>
